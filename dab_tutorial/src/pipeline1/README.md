...
This folder defines all source code for the 'pipeline1' pipeline:
...
* Take a look at the sample under "sample_users_pipeline1.py" to get familiar with the syntax.
